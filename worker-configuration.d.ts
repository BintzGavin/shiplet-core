/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 09101eaaa7b2812cca639219d7aaf5f6)
...
interface __BaseEnv_Env {
	...
	DISPATCH_NAMESPACE_NAME: "shiplet-example";
	SHIPLET_APP_URL: "http://localhost:8787";
	WORKOS_AUTHKIT_ISSUER: "https://example.authkit.app";
	WORKOS_REDIRECT_URI: "http://localhost:8787/auth/callback";
	SHIPLET_ENABLED_FEATURE_FLAGS: "example-feature";
	...
	SHIPLET_ROOT: DurableObjectNamespace<import("./src/index").ShipletRoot>;
	CLOUDFLARE_OAUTH_CONTROL_PLANE: Service /* entrypoint CloudflareOAuthControlPlane from shiplet-example-control-plane */;
	CLOUDFLARE_GRANT_VAULT_RPC: Service /* entrypoint CloudflareGrantVaultRpc from shiplet-example-control-plane */;
	CLOUDFLARE_TEMPORARY_ACCOUNT_RPC: Service /* entrypoint CloudflareTemporaryAccountRpc from shiplet-example-control-plane */;
	CLOUDFLARE_VERSION_HEALTH_RPC: Service /* entrypoint CloudflareVersionHealthRpc from shiplet-example-runtime-gateway */;
	CLOUDFLARE_CUSTOM_MCP_RUNTIME_RPC: Service /* entrypoint CustomMcpRuntimeRpc from shiplet-example-runtime-gateway */;
	CLOUDFLARE_MANAGED_RUNTIME_RPC: Service /* entrypoint ManagedRuntimeGateway from shiplet-example-runtime-gateway */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SandboxSession" | "ShipletRoot";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHIPLET_AUTH_MODE" | "DISPATCH_NAMESPACE_NAME" | "SHIPLET_APP_URL" | "WORKOS_AUTHKIT_ISSUER" | "WORKOS_REDIRECT_URI" | "SHIPLET_ENABLED_FEATURE_FLAGS" | "CLOUDFLARE_OAUTH_READINESS" | "CLOUDFLARE_OAUTH_SMOKE_USER_ID" | "CLOUDFLARE_CONTROL_PLANE_VERSION_ID" | "CLOUDFLARE_RUNTIME_GATEWAY_VERSION_ID" | "CLOUDFLARE_DENY_EGRESS_VERSION_ID" | "CLOUDFLARE_SUPPORT_RELEASE_TAG" | "CLOUDFLARE_MANAGED_RUNTIME_READINESS" | "CLOUDFLARE_MANAGED_RUNTIME_SMOKE_USER_ID" | "CLOUDFLARE_MANAGED_RUNTIME_OPERATOR_USER_ID" | "CLOUDFLARE_TEMPORARY_ACCOUNTS_READINESS" | "CLOUDFLARE_TEMPORARY_ACCOUNTS_SMOKE_USER_ID" | "CUSTOM_DOMAIN">> {}
}
declare module "*.svg" {
	const value: string;
