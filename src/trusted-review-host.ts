...
[data-shiplet-revision-preview-context]{display:flex;gap:16px;align-items:center;justify-content:space-between;padding:16px 20px 16px 170px;border-bottom:1px solid var(--shiplet-line);background:var(--shiplet-surface);color:var(--shiplet-ink);font:14px/1.5 system-ui,sans-serif}[data-shiplet-revision-preview-context] p{margin:0;max-width:75ch}[data-shiplet-revision-preview-context] code{overflow-wrap:anywhere;font-size:12px}[data-shiplet-revision-preview-context] nav{display:flex;gap:12px;flex-wrap:wrap;flex-shrink:0}[data-shiplet-revision-preview-context] a{color:var(--shiplet-accent);font-weight:700;text-underline-offset:3px}[data-shiplet-revision-preview-context]+main{height:calc(100vh - 100px)}@media(max-width:720px){[data-shiplet-revision-preview-context]{padding:64px 16px 16px;align-items:flex-start;flex-direction:column;gap:8px}[data-shiplet-revision-preview-context] nav{gap:16px}[data-shiplet-revision-preview-context] a{min-height:44px;display:inline-flex;align-items:center}}
